...
public class Tests {
    ...
    public void TestCouponRemove()
    {
        ...
        assertEquals(3,this.couponOperations.getCouponsForWebsite(w1).size());
        this.couponOperations.removeCoupon("a");
        assertEquals(2,this.couponOperations.getCouponsForWebsite(w1).size());
